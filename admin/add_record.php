...
// Get type from URL (student or teacher)
...
<head>
    ...
    <title>Add <?php echo ucfirst($type); ?> - MITAOE Admin</title>
    ...
    <div class="main-content">
        ...
        <header class="header">
            <div class="breadcrumb">
                ...
                <a href="add_record.php?type=<?php echo $type; ?>">Add Record</a> <span>&gt;</span> 
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <h1><?php echo $type === 'student' ? '👨‍🎓' : '👨‍🏫'; ?> Add New <?php echo ucfirst($type); ?></h1>
                <p>Fill in the details below to add a new <?php echo $type; ?> record</p>
            </div>

            <!-- Type Selector -->
            <div class="type-selector">
                <a href="add_record.php?type=student" class="type-btn <?php echo $type === 'student' ? 'active' : ''; ?>">
                    <i class='bx bxs-user-detail'></i> Student
                </a>
                <a href="add_record.php?type=teacher" class="type-btn <?php echo $type === 'teacher' ? 'active' : ''; ?>">
                    <i class='bx bxs-user-badge'></i> Teacher
                </a>
            </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="prn" class="form-control" placeholder="e.g., 2024001" required>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="batch_year" class="form-control" placeholder="e.g., 2024" required min="2000" max="2100">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="parent_name" class="form-control" placeholder="Enter parent/guardian name">
                                </div>
                                <div class="form-group">
                                    <label>Parent Phone</label>
                                    <input type="tel" name="parent_phone" class="form-control" placeholder="+91 9876543210">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" placeholder="teacher@mitaoe.ac.in" required>
                                </div>
                                <div class="form-group">
                                    <label>Phone Number <span class="required">*</span></label>
                                    <input type="tel" name="phone" class="form-control" placeholder="+91 9876543210" required>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="experience" class="form-control" placeholder="e.g., 5" required min="0" max="50">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <div class="radio-group">
                                        <div class="radio-option">
                                            <input type="radio" id="active_teacher" name="is_active" value="1" checked>
                                            <label for="active_teacher">Active</label>
                                        </div>
                                        <div class="radio-option">
                                            <input type="radio" id="inactive_teacher" name="is_active" value="0">
...
window.addEventListener('orientationchange', () => {
    ...
    <script>
        ...
        form.addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('../php/add_record_handler.php', {
                    method: 'POST',
                    body: formData
                });
